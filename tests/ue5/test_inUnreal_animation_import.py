...
# 새 인터페이스: 직접 경로 지정
fbxPath = r'E:\DevStorage_root\DevStorage\Characters\NormalMonster\GumhoDistrictBully\Male\Animation\Battle\Action\Fist\A_Nm_GHDtBully_M_Battle_Action_Fist_MonsterSkill_1.fbx'
destinationPath = r'/Game/Omni/Characters/NormalMonster/GumhoDistrictBully/Male/Animation/Battle/Action/Fist'
...
assetName = r'A_Nm_GHDtBully_M_Battle_Action_Fist_MonsterSkill_1'  # 선택적: 빈 문자열이면 FBX 파일명 기반 자동 생성
