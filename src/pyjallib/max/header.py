...
from .jacketPanel import JacketPanel
...
from .hip import Hip
from .ue5Skeleton import UE5Skeleton
...
class Header:
    ...
    def __init__(self):
        ...
        self.jacketPanel = JacketPanel(nameService=self.name, animService=self.anim, helperService=self.helper, boneService=self.bone, constraintService=self.constraint, alignService=self.align)
        ...
        self.ankle = Ankle(nameService=self.name, animService=self.anim, constraintService=self.constraint, boneService=self.bone, helperService=self.helper)
